...
function getListboxAsObj() {
    ...
    for (var i = 0; i < len; ++i) {
        ...
        obj.push([item.firstChild.getAttribute("label"), item.lastChild.getAttribute("label")])
    }
    return obj
}
...
function deleteSubst() {
    ...
    if (i === listbox.getRowCount()) i = i - 1
...
function doHelp() {
    ...
    var text = win.document.getElementById("furiganainserter-strings").getString("filterHelp")
